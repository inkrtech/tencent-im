...
const (
	...
	InviteJoinOptionFreeAccess     InviteJoinOption = "FreeAccess"     // 自由邀请
	InviteJoinOptionNeedPermission InviteJoinOption = "NeedPermission" // 需要验证
	InviteJoinOptionDisableInvite  InviteJoinOption = "DisableInvite"  // 禁止邀请
...
type Group struct {
	...
	inviteJoinOption string                 // 邀请加群处理方式
	members          []*Member              // 群成员
